...
const Contact = () => {
    const onSubmit = async (event) => {
        ...
        formData.append("access_key", "605c97ca-acd1-410e-8bc6-ce45599bca44");
            ...
            <div className="contact-left">
                ...
                <div className="contact-details">
                    <div className="contact-detail">
                        <img src={mail_icon} alt="" /> <p>gnanasekar03x@gmail.com</p>
                    </div>
                    <div className="contact-detail">
                        <img src={call_icon} alt="" /><p>+91 9080396738</p>
                    </div>
                    <div className="contact-detail">
